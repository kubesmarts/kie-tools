...
| management-console.image                | object | `{"account":"kubesmarts","name":"incubator-kie-kogito-management-console","pullPolicy":"IfNotPresent","registry":"quay.io","tag":"main"}`                                                                                                               | Image source configuration for the Management Console image                                                                                      |
