...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PodTemplateMeta) DeepCopyInto(out *PodTemplateMeta) {
	*out = *in
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PodTemplateMeta.
func (in *PodTemplateMeta) DeepCopy() *PodTemplateMeta {
	if in == nil {
		return nil
	}
	out := new(PodTemplateMeta)
	in.DeepCopyInto(out)
	return out
}
